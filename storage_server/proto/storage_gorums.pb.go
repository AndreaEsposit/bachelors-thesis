...
func (n *Node) Read(ctx context.Context, in *ReadRequest) (resp *State, err error) {
...
func (n *Node) Write(ctx context.Context, in *State) (resp *WriteResponse, err error) {
...
func (s *GorumsServer) RegisterStorageServer(srv Storage) {
	s.srv.handlers[readMethodID] = func(ctx context.Context, in *gorumsMessage, finished chan<- *gorumsMessage) {
		req := in.message.(*ReadRequest)
		once := new(sync.Once)
		f := func(resp *State, err error) {
			once.Do(func() {
	...
	s.srv.handlers[writeMethodID] = func(ctx context.Context, in *gorumsMessage, finished chan<- *gorumsMessage) {
...
const readMethodID int32 = 0
const writeMethodID int32 = 1

var orderingMethods = map[int32]methodInfo{

	0: {requestType: new(ReadRequest).ProtoReflect(), responseType: new(State).ProtoReflect()},
	1: {requestType: new(State).ProtoReflect(), responseType: new(WriteResponse).ProtoReflect()},
}
