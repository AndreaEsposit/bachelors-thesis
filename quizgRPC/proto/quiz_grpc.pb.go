...
func (c *quizClient) Next(ctx context.Context, opts ...grpc.CallOption) (Quiz_NextClient, error) {
	stream, err := c.cc.NewStream(ctx, &Quiz_ServiceDesc.Streams[0], "/proto.Quiz/Next", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *quizClient) Signup(ctx context.Context, in *User, opts ...grpc.CallOption) (Quiz_SignupClient, error) {
	stream, err := c.cc.NewStream(ctx, &Quiz_ServiceDesc.Streams[1], "/proto.Quiz/Signup", opts...)
	if err != nil {
		return nil, err
	}
